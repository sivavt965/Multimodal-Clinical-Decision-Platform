...
export const RISK_BADGE_COLORS: Record<RiskBadge, { bg: string; text: string; border: string }> = {
  'Unlikely':      { bg: 'bg-gray-100',   text: 'text-gray-600',  border: 'border-gray-300' },
  'Monitor':       { bg: 'bg-yellow-100', text: 'text-yellow-800', border: 'border-yellow-400' },
  'Elevated Risk': { bg: 'bg-red-100',    text: 'text-red-800',    border: 'border-red-500'  },
} as const;
